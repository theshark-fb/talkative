package com.epsi.talkative.talkative.resource;
...
import com.epsi.talkative.talkative.repository.Editor;
import com.epsi.talkative.talkative.resources.TalkativeApplication;
...
public class ArticlesResourceTest {
        ...
        @Module
        @Classes(com.epsi.talkative.talkative.repository.EditorRepository.class)
        public EjbJar ejb() {
                return new EjbJar();
        }
